      ...
      <div className="login-shell login-shell--tall">
        <div className="login-glass login-glass--wide animate-fade-in">
          ...
          <Text as="p" size="2" color="gray" mb="4">
            {codesPending
              ? 'Приложение привязано. Осталось сохранить резервные коды.'
              : `${user?.full_name ? `${user.full_name}, вход` : 'Вход'} защищён `
                + 'вторым фактором. Привяжите приложение — дальше оно будет '
                + 'спрашивать код при каждом входе.'}
          </Text>
